...
<head>
    ...
    <title>Agriculture论坛 - 铲屎官专区</title>
...
<body class="gray-bg">
    ...
    <div class="wrapper wrapper-content  animated fadeInRight blog" style="padding-top: 75px;">
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox">
                    <div class="ibox-content">
                        <a href="${pageContext.request.contextPath}/animals/animalsContent" class="btn-link">
                            <h2>
