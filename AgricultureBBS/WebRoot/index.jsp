...
<body class="gray-bg">
        ...
        <div class="container-fluid">  
            ...
            <div class="collapse navbar-collapse" id="example-navbar-collapse">  
                <ul class="nav navbar-nav">  
                    ...
                    <li><a href="${pageContext.request.contextPath}/animals/animalsList">铲屎官</a></li>  
                    <li>  
                        <a href="#">德鲁伊</a>  
                    </li>  
                </ul>  
    ...
    <div class="row">
        <div class="wrapper wrapper-content animated fadeInRight" style="padding-top: 57px;">
            <div class="row">
                <div class="col-sm-12">
